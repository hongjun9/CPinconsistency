...
class MPImage():
    ...
    def child_task(self):
        ...
        mp_util.close_low_fds()
        import wx
        state = self

        self.app = wx.PySimpleApp()
        self.app.frame = MPTabbedFrame(state=self)
        self.app.frame.Show()
        self.app.MainLoop()
    ...
    def set_image(self, img, tab=None, bgr=False):
        ...
        self.in_queue.put(MPImageData(img, tab))
...
if __name__ == "__main__":
    ...
    im.set_image(img, bgr=True, tab='TabOne')
